          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card-people mt-auto">
                <div class="card-people mt-auto">
                  <h3 class="font-weight-bold" style="text-align: center">お帰りなさい {{Auth()->user()->firstname}}-san !</h3>
                  <img src="/assets-admin/images/dashboard/people.png" alt="people">
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      <p class="mb-4">Jumlah Pengajuan Pendaftaran Pasien</p>
                      <p class="fs-30 mb-2">{{$jumlahpengajuan}} Pengajuan Pasien</p>
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      <p class="mb-4">Terkonfirmasi </p>
                      <p class="fs-30 mb-2">{{$jumlahterkonfirmasi}} Terkonfirmasi</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      <p class="mb-4">Jumlah User Terdaftar</p>
                      <p class="fs-30 mb-2">{{$jumlahuser}} User Yang Terdaftar</p>
